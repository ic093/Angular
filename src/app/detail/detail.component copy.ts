...
import { ThModule, RowsModule, RowstationsModule } from '../weather.module'; //引入WeatherModule介面
...
export class DetailComponent implements OnInit {
  //用implements OnInit 在typecscript
  th: ThModule[] = []; //宣告th為WeatherModule介面
  rows: RowsModule[] = [];
  ...
  updateWeather(): void {
    ...
    this.rowstations = [
      { city: '縣市', count: '氣象站' },
      // { city: this.cityStationCount.city, station: '' },
      // { city: '', station: '' },
      // { city: '', station: '' },
    ];
